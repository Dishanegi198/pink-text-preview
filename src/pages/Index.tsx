      ...
      <div className="min-h-screen w-full">
        ...
        <section className={cn(
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <p>
              The <a href="https://www.imdb.com/title/tt1517268/" target="_blank" rel="noopener noreferrer" className="text-barbie-hotPink font-medium hover:text-barbie-purple transition-colors underline decoration-dotted underline-offset-2">2023 Barbie movie</a> directed by Greta Gerwig brought a fresh wave of Barbie enthusiasm to audiences worldwide. The film's distinctive visual style, including its custom typography, created a new benchmark for Barbie aesthetics. Our font generator incorporates elements from this cinematic milestone, giving you access to typography that evokes the modern, self-aware Barbie brand that captivated millions of viewers.
            </p>
            <p>
